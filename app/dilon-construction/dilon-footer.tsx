        ...
        <footer className="bg-gray-900 text-white py-12 mt-0">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-xl font-semibold mb-4">Dilon Construction</h3>
                        <p className="mb-4">Your Partner in the Construction Industry.</p>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center">
                    <p>&copy; {new Date().getFullYear()} Dilon Construction. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
